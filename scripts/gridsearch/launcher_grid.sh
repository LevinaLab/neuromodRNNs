...
VALID_TASKS=("pattern_generation" "cue_accumulation" "delayed_match" "hard_delayed_match" "fully_connected_cue_accumulation" "fully_connected_pattern_generation" "fully_connected_delayed_match" "full_recurrent_cue_accumulation" "full_recurrent_delayed_match" "full_recurrent_pattern_generation")
