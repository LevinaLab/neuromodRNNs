...
def train_and_evaluate(cfg) -> TrainState:
    ...
    plots.plot_LSNN_weights(state,layer_names=layer_names,
                       save_path=os.path.join(figures_directory, "weights.png"))
  
    
    plots.plot_weights_spatially_indexed(state, cfg.net_arch.gridshape,os.path.join(figures_directory, "spatially_weights.png"))
    #
    ...
    # Save the figure
    fig_train.savefig(os.path.join(figures_directory, "training.png"), format="png")
    plt.close(fig_train)
    ...
    fig1.tight_layout()
    fig1.savefig(os.path.join(figures_directory, "example_1.png"), format="png")      
    plt.close(fig1)
    ...
    fig2.tight_layout()
    fig2.savefig(os.path.join(figures_directory, "example_2.png"),format="png")      
    plt.close(fig2)
    ...
    fig3.tight_layout()
    fig3.savefig(os.path.join(figures_directory, "example_3.png"),format="png")   
    plt.close(fig3)
